...
/*******************************************
 * スクロール時のフェードアップ表示
 * 各 section 内のテキスト要素を最初は透明・少し下に配置し、
 * 画面内に入ったら下から上へ移動しながら表示する。
 * （section 全体ではなくテキストのみ対象にして背景色を保つ）
 *
...
// section 内のテキスト要素セレクタ（ヘッダー用ラッパーは除外）
const TEXT_SELECTOR = 'h1, h2, h3, h4, h5, h6, p, li, dt, dd, th, td, figcaption, blockquote';
